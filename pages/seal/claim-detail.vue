<template>
	<view class="page">
		...
		<view class="card">
			...
			<view class="detail-item">
				<text class="label">用印时间</text>
				<text class="value">{{ detailData.approvalSTime }}</text>
			</view>
			<view class="detail-item">
				<text class="label">用印单位</text>
				<text class="value">
					<view class="list">
			...
			<view v-if="isShowOther" class="detail-item">
				<text class="label">其他用印种类</text>
				<text class="value">{{ detailData.approvalTitle }}</text>
			</view>
			<view class="detail-item">
				<text class="label">项目名称</text>
				<text class="value">{{ detailData.address }}</text>
			</view>
			<view class="detail-item">
				<text class="label">用印份数</text>
				<text class="value">{{ detailData.number }}</text>
			</view>
			<view class="detail-item">
				<text class="label">用印事由</text>
...
import { getClaimInfo, accept, rollback, flowList as getFlowList, returnUserList, updateDone, uploadPayment, getExpenseType,
 queryAllLevelTwoParamMap, getProjectClaim} from '@/api/office/seal.js';

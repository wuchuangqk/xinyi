<template>
  <view class="app-page">
    <view class="list-search-wrap">
      <u-search placeholder="输入资产名称搜索" v-model="params.title" :show-action="false" @search="search"
...
export default {
  ...
  methods: {
    ...
    navToDetail(id) {
      ...
      uni.navigateTo({
        url: `/pages/leave-list/leave-detail?dataId=${id}&url=/zhigou/zhigou_detail&isApprove=${isApprove}`,
      });
    },
  }
}

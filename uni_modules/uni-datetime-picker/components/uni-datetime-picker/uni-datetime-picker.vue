<template>
	<view class="uni-date">
		...
		'uni-date-x--border': border}">
			...
			<view v-show="!disabled && (singleVal || (range.startDate && range.endDate)) && showClear" class="uni-date__icon-clear"
				@click="clear">

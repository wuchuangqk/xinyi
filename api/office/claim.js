...
// /api/baoXiao/index
// 报销管理
export function getMyClaimPageList(pageIndex, pageSize) {
	return request({
		url: '/oa/api/baoXiao/index',
		method: 'GET',
		data: {
			pageIndex,
			pageSize,
...
// 报销审批列表
export function getMyWaitPageList(pageIndex, pageSize) {
	return request({
		url: '/oa/api/baoXiao/auditList',
		method: 'GET',
		data: {
			pageIndex,
			pageSize,
...
// /api/baoXiao/doneList
// 报销已办审批列表
export function getMyEndPageList(pageIndex, pageSize) {
	return request({
		url: '/oa/api/baoXiao/doneList',
		method: 'GET',
		data: {
			pageIndex,
			pageSize,
...
// /api/baoXiao/getliuChengJianKongList
// 流程监控
export function getFlowMonitorPageList(pageIndex, pageSize, userId, creatorName, approvalContent) {
	return request({
		url: '/oa/api/baoXiao/getliuChengJianKongList',
		method: 'GET',
		data: {
			userId,
			pageIndex,
...
export function getClaimInfo(id) {
	return request({
		url: `/oa/api/baoXiao/info/${id}`,
		method: 'GET',
	})
}

// /api/baoXiao/flowList/{id}
// 签署流程
...
export function save(data) {
	return request({
		url: `/oa/api/baoXiao/saveOrUpdate`,
		method: 'post',
		data
	})
}
...
// /api/baoXiao/uploadPayment
// 上传报销费用单
export function uploadPayment(data) {
	return request({
		url: '/oa/api/baoXiao/uploadPayment',
		method: 'post',
		data
	})
}
